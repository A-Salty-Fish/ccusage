...
Configure Claude Code, Codex, OpenCode, Amp, Droid, Codebuff, Hermes Agent, pi-agent, Goose, OpenClaw, Kilo, Kimi, Qwen, GitHub Copilot CLI, Cursor, Gemini CLI, Antigravity, Grok Build CLI, and ZCode separately with data source namespaces:
